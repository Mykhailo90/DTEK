            ...
            <div class="wrapper">
                ...
                <section class="menu menu--off">
                    <?php foreach($navMenu as $item) { ?>
                        <div>
                            <a href="<?php echo '/programs_catalog/' . $item['path_to_program']; ?>"><?php echo $item['title']; ?></a>
                        </div>
                    <?php } ?>
                </section>
            </div>
    ...
    <footer>
        <div class="frame">
            ...
            <div class="footer_blocks_1">
                ...
                <ul>
                    <li><a href="https://dtekacademy.com/programs/module_progams/">Долгосрочные программы</a></li>
                    <li><a href="https://dtekacademy.com/programs/trenings/">Мастер классы</a></li>
                    <li><a href="https://dtekacademy.com/programs/team_buildings/">Тимбилдинг</a></li>
