var jsCalendar = (function(){
    ...
    JsCalendar.prototype._create = function() {
        ...
        for (i = 0; i < 2; i++) {
            ...
            this._elements.headRows.push(document.createElement('div'));
        ...
        for (i = 0; i < 7; i++) {
            this._elements.days.push(document.createElement('div'));
        ...
        // 6 rows
        for (i = 0; i < 6; i++) {
            this._elements.bodyRows.push(document.createElement('div'));
            this._elements.body.appendChild(this._elements.bodyRows[i]);
            // 7 days
            for (j = 0; j < 7; j++) {
                this._elements.bodyCols.push(document.createElement('div'));
